...
def parse_args():
    ...
    ## the input file
    parser.add_argument('--input_pheno', nargs='?', default='..\..\data\process_feature\disease_gene.csv',
                        help='Input disease_gene_relationship file')
    parser.add_argument('--input_miRNA', nargs='?', default='..\..\data\process_feature\miRNA_gene.csv',
                        help = 'Input miRNA_gene_relationship file')
    parser.add_argument('--input_positive',nargs = '?',default='..\..\data\process_feature\pos.txt',
                        help='positive samples')
    parser.add_argument('--input_negative', nargs='?', default='..\..\data\process_feature\\neg.txt',
                        help='negative samples')
    parser.add_argument('--output', nargs='?', default='..\..\data\process_feature\output_file\disease_miRNA.csv',
                        help = 'Output low-dimensional disease_miRNA file')
    parser.add_argument('--label_file', nargs='?', default='..\..\data\process_feature\output_file\label.csv',
                        help='Output label file')
    parser.add_argument('--dimensions', nargs='?', default=2048,
    ...
    parser.add_argument('--input_n_size', nargs='?', default=[5367, 2048])
    parser.add_argument('--hidden_size', nargs='?', default=[2048])
    parser.add_argument('--gene_num', nargs= '?', default = 5367,
